...
{
    public class HazopController : Controller
    {
        #region config
        ...
        public HazopController(ILogger<HazopController> logger,
        ...
        public async Task<IActionResult> next_page([FromBody] LoadSessionDataViewModel model)
        {
            ...
            {
                //กรณีที่เป็น Follow Up ให้ไปเลือกในหน้า Moduel นั้นๆ เอง เดียวสับสนถ้าเลือกจกาหน้านี้
                ...
                //else
                //{
                _sessionAuthen.controller_action_befor = ("hazop");
                _sessionAuthen.pha_seq = (model.pha_seq + "");
        ...
        public IActionResult Index()
        {
            ...
            {
                //return View("Index", "Hazop");//focus tab manage
            }
