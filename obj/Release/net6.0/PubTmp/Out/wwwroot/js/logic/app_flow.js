...
angular.module('myApp', []).controller('myController', function ($scope, $filter) {
  ...
  $scope.GuideWordslist = [
    { id: 'id', type: "type", deviations: 'deviations', guidewords: 'guidewords', process: "process", area: 'area', selected: true, seq: 0 },
    { id: '1', type: "Flow", deviations: 'None', guidewords: 'No Flow', process: "Incorrect routing – blockage – burst pipe – large leak – equipment failure (C.V., isolation valve, pump, vessel, etc.) – incorrect pressure differential – isolation in error –etc.", area: 'System', selected: true, seq: 0 },
    ...
    { id: '3', type: "Flow", deviations: 'More of ', guidewords: 'More/High Flow', process: "Increased pumping capacity – reduced delivery head – increased suction pressure – static generation under high velocity – pump gland leaks –etc.", area: 'System', selected: true, seq: 0 },
    ...
    { id: '5', type: "Flow", deviations: 'Misdirected', guidewords: 'Misdirected Flow', process: "Flow directed to stream other than intended due to misalignment of valves –etc.", area: 'System', selected: true, seq: 0 },
    { id: '6', type: "Pressure", deviations: 'More of', guidewords: 'More/High Pressure', process: "Surge problems(line and flange sizes) – relief philosophy (process / fire etc.) – connection to high pressure system – gas breakthrough(inadequate venting) – defective isolation procedures for relief valves – thermal overpressure – positive displacement pumps – failed closed PCV's – design pressures – relief valve – specifications of pipes – vessels – fittings – instruments – type of relief device and reliability – discharge location – inlet - outlet piping – etc.", area: 'System', selected: true, seq: 0 },
    { id: '7', type: "Pressure", deviations: 'Less of', guidewords: 'Less/Low Pressure', process: "Generation of vacuum condition – restricted pump / compressor suction line – vessel drainage –etc.", area: 'System', selected: true, seq: 0 },
    { id: '8', type: "Temperature", deviations: 'More of', guidewords: 'More/High Temperature', process: "Ambient conditions – fire situation – high than normal temperature – fouled cooler tubes – cooling water temperature wrong –cooling water failure – defective control – heater control failure – internal fires –etc.", area: 'System', selected: true, seq: 0 },
    { id: '9', type: "Temperature", deviations: 'Less of', guidewords: 'Less/Low Temperature', process: "Ambient conditions – reducing pressure – loss of heating – depressurisation of liquefied gas – Joule Thompsoneffect – line freezing –etc.", area: 'System', selected: true, seq: 0 },
    { id: '10', type: "Viscosity", deviations: 'More of', guidewords: 'More Viscosity', process: "incorrect material spec, temperature etc.", area: 'System', selected: true, seq: 0 },
    { id: '11', type: "Viscosity", deviations: 'Less of', guidewords: 'Less Viscosity', process: " as above", area: 'System', selected: true, seq: 0 },
    { id: '12', type: "Viscosity", deviations: '', guidewords: 'Composition change', process: "passing isolation valves, etc.", area: 'System', selected: true, seq: 0 },
    { id: '13', type: "Viscosity", deviations: '', guidewords: 'Contamination', process: "wrong material, wrong operation, ingress of air, shutdown and start up conditions, etc.", area: 'System', selected: true, seq: 0 },
    { id: '14', type: "Level", deviations: 'More of', guidewords: 'More/ High Level', process: "Outlet isolated or blocked – inflow greater than outflow –control failure – faulty level measurement –etc.", area: 'optional', selected: true, seq: 0 },
    { id: '15', type: "Level", deviations: 'Less of', guidewords: 'Less/ Low Level', process: "Inlet flow stops – leak – outflow greater than inflow – control failure – faulty level measurement – draining of vessel –etc.", area: 'optional', selected: true, seq: 0 },
    { id: '16', type: "Other Than ", deviations: 'Vent / PURGE', guidewords: '', process: "Vent / Purge –Toxic / Flammable", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '17', type: "Other Than ", deviations: 'INSTRUMENTATION', guidewords: '', process: "Analyzer - flow measurement - location of instrumentation / alarm – indicators – recorders –etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '18', type: "Other Than ", deviations: 'Sampling', guidewords: '', process: "Sampling Point location, sampling point specification / feature, etc", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '19', type: "Other Than ", deviations: 'Corrosion / Erosion', guidewords: '', process: "Corrosion / Erosion – Internal / External Corrosion at flare tips – etc. Internal / external corrosion protection – engineering specifications – stress corrosion cracking – fluid velocities –etc. ", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '20', type: "Other Than ", deviations: 'Service Failure / Utilities / Services', guidewords: '', process: "Loss of electricity – instrument air – fuel gas – cooling water– steam –nitrogen –etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '21', type: "Other Than ", deviations: 'Leakage', guidewords: '', process: "From tube side to shell side of exchanger, roof drain leakage - etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '22', type: "Other Than ", deviations: 'Maintenance Static', guidewords: '', process: "System drainage(how and where to) – isolation of equipment and prep for maintenance shutdown and start up(how) –etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '23', type: "Other Than ", deviations: 'Spare Equipment', guidewords: '', process: "Installed or not installed–Availability of spares –Modified specifications –Storage of spares –etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '24', type: "Other Than ", deviations: 'Safety & Human Factor', guidewords: '', process: "Lagging, fire fighting, toxic gas, safety shower, hot / cold surface etc., security Hot work –Hot surfaces –Electrical classification –Auto - ignition or pyrophoric materials– etc.", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '25', type: "Other Than ", deviations: 'Safety & Human Factor', guidewords: '', process: "Safety for Operation & Ergonomic, Vehicles crash Feed stream impurities (e.g., mercury, H 2S, CO 2) –Dust generation–Powder handling– etc.Confined Space / Escape & Evacuation / Work at High Elevation & Dropped Object", area: 'Vessel or unit', selected: true, seq: 0 },
    { id: '26', type: "Optional Guidewords", deviations: 'Erosion', guidewords: '', process: "Internal/ external corrosion protection – engineering specifications – stress corrosion cracking – fluid velocities –etc. ", area: 'optional', selected: true, seq: 0 },
    { id: '27', type: "Optional Guidewords", deviations: 'Phase', guidewords: '', process: "Phase change", area: 'optional', selected: true, seq: 0 },
    { id: '28', type: "Optional Guidewords", deviations: 'Traffic', guidewords: '', process: "Vehicles crash", area: 'optional', selected: true, seq: 0 },
    { id: '29', type: "Optional Guidewords", deviations: 'Operations / Start Up / Shutdown', guidewords: '', process: "Purging – flushing –clearing blockages – steam out – start - up – normal shutdown – emergency shutdown – emergency operations – inspection of operating machines – guarding of machinery –etc.", area: 'optional', selected: true, seq: 0 },
    { id: '30', type: "Optional Guidewords", deviations: 'Maintenance / Inspection', guidewords: '', process: "Provision and adequacy for testing of equipment and product – location of sampling points – consistent philosophy –vibration detection –control separate from alarms – shutdowns –etc.", area: 'optional', selected: true, seq: 0 },
    { id: '31', type: "Optional Guidewords", deviations: 'Time', guidewords: '', process: "Too long–Too short –Wrong time–Time for analysis results – too soon–etc.", area: 'optional', selected: true, seq: 0 },
    { id: '32', type: "Optional Guidewords", deviations: 'Mixing', guidewords: '', process: "Fast mixing –Slow mixing–No mixing –etc.", area: 'optional', selected: true, seq: 0 },
    { id: '33', type: "Optional Guidewords", deviations: 'Reaction', guidewords: '', process: "Reaction by-products, missing reactions", area: 'optional', selected: true, seq: 0 },
    { id: '34', type: "Optional Guidewords", deviations: 'Information', guidewords: '', process: "Confusing – Inadequate – Missing –Misinterpreted – Partial– Stress –Wrong information– etc.", area: 'optional', selected: true, seq: 0 },
    { id: '35', type: "Optional Guidewords", deviations: 'Fire & Explosion ', guidewords: '', process: "Adjacent facillity exposure from fire/explosion Lagging – firefighting –– safety showers – security –Adjacent facility exposures – etc.", area: 'optional', selected: true, seq: 0 },
    { id: '36', type: "Optional Guidewords", deviations: 'Toxic', guidewords: '', process: "Feed stream impurities (e.g., mercury, H 2S, CO 2) –Dust generation–Powder handling– etc.", area: 'optional', selected: true, seq: 0 },
    { id: '37', type: "Optional Guidewords", deviations: 'Corrosive', guidewords: '', process: "Cathodic protection arrangements (internal and external) – Coating applications –Corrosion monitoring methods and – frequencies – Materials specification – Stress corrosion cracking – Fluid velocities –Sour service(e.g., H 2 S) –Riser splash zone– etc.", area: 'optional', selected: true, seq: 0 },
    { id: '38', type: "Optional Guidewords", deviations: 'Hot/ Cold Surface', guidewords: '', process: "Hot work –Hot surfaces –Electrical classification –Auto-ignition or pyrophoric materials– etc.", area: 'optional', selected: true, seq: 0 },
    { id: '39', type: "Optional Guidewords", deviations: 'Human Factor & Ergonomic', guidewords: '', process: "Access - Equipment Operation - Labelling– identification– instructions– training– qualifications– etc.", area: 'optional', selected: true, seq: 0 },
    { id: '40', type: "Optional Guidewords", deviations: 'Confined Space/ Escape & Evacuation / Work at High Elevation & Dropped Object', guidewords: '', process: "Lift and manual handling, Work permit system, Rescue plan, Training", area: 'optional', selected: true, seq: 0 },
  ];
  ...
  $scope.DataNodeList = [{ no: 1, seq: 1, node_text: 'xx1', design_intent: '', design_conditions: '', operating_conditions: '', node_boundary: '', node_drawing: '' },];
  ...
  $scope.selectExpense_Type ='OPEX';
  $scope.selectedDataRamType = '5';
  $scope.selectedItemAPU = 'A';
  $scope.selectedItemBU = '';
  $scope.selectSendBack = 'option1';
  $scope.selectViewTypeFollowup = '2';
  $scope.selectViewTypeFollowup2 = '2';


  $scope.ViewTypeFollowup = function ( a) {
     
    $scope.selectViewTypeFollowup = a;
  };

  $scope.ViewTypeFollowup2 = function ( a) {
     
    $scope.selectViewTypeFollowup2 = a;
  };
  ...
  // $scope.addDataWorkSheet = function() {
  //   var newRow = { 
  //     no: $scope.WorkSheetJSAE.length +1 ,
  //     work_step: "", 
  //     task_description: "", 
  //     potentail: "", 
  //     causes: "" , 
  ...
  //     action:'' , 
  //     ram_after_security: '', 
  //     ram_after_likelihood: '', 
  //     ram_after_risk: '',
  //     type: 'workstep'
  //   };

  //   $scope.WorkSheetJSAE.push(newRow);
  // };
  ...
  $scope.addText = function() {
    ...
    var newText1 = $scope.Name;
    var newText2 = $scope.Email;
    var newText3 = 'Vender';
    // var newText4 = $scope.Section;
      ...
      var emprow = {id:$scope.employeelist.length + 1, employee: newText1, email: newText2 ,department:newText3 ,section:'' ,profile: 'assets/img/team/35.webp', selected: false, seq: 0};
  ...
  // $scope.searchWordData = $scope.employeelist;

  // $scope.searchData = function() {
  //   var searchText = $scope.searchText.toLowerCase();

  //   $scope.searchWordData = $scope.employeelist.filter(function(item) {
  //     return (
 ...
 $scope.wordcheck = function(word){
  ...
  $scope.confirmjsea = function(){
    ...
    Swal.fire({
      title: 'Confirmation',
      text: 'Task Name: '+ $scope.inputValue +' '+'Unit'+ $scope.unit,
      icon: 'question',
      ...
      if (result.isConfirmed) {
        ...
        // $scope.wordcheck($scope.inputValue);
      } 
    });
  ...
  // var no = $scope.no;
  // var doti = $scope.doti;
  // var dotii = $scope.dotii;
  // var dotiii = $scope.dotiii;
  ...
  $scope.WorkSheetWhat_if = [
    
    {
      ...
      Causes: '' , 
      Consequence: '' , 
      ram_before_security: '4', 
      ram_before_likelihood: 'c', 
      ram_before_initialrisk: 'm', 
      Safeguard : '',
      ram_after_security: '4', 
      ram_after_likelihood: 'b', 
      ram_after_risk: 'm',
      Recommendations : '',
      action:'' , 
      type: 'list'
  ...
  $scope.addWhatWorkSheetB = function(rowType,rowIndex) {
  ...
  //  var index = ''+i+'.'+doti+'.'+dotii+'.'+dotiii;
    ...
    if (rowType === 'list_sub') {
      ...
      console.log(no+'.'+doti+'.'+dotii+'.'+dotiii);
      $scope.WorkSheetWhat_if.splice(rowIndex + 1, 0, newRow);
    } else if(rowType === 'cause') {
      ...
      $scope.WorkSheetWhat_if.push(newRow);
  ...
  $scope.removeWhatWorkSheet = function(index) {


        $scope.WorkSheetWhat_if.splice(index, 1);
  ...
  $scope.WorkSheetJSAE = [
    {
      ...
      potentail: '', 
      causes: '' , 
      ram_befor_security: '4', 
      ram_befor_likelihood: 'c', 
      ram_befor_risk: 'm', 
      recommendations: '',
      action:'' , 
      ram_after_security: '4', 
  ...
  $scope.addDataWorkSheetB = function(rowType,rowIndex,rowNo,rowNoi) {
    ...
    if (rowType === 'task') {
      ...
      console.log(no+'.'+newRow.nodoti +'.'+dotii+'.'+dotiii);
      $scope.WorkSheetJSAE.splice(rowIndex + 1, 0, newRow);
    } else if(rowType === 'potential') {
  ...
  $scope.removeDataWorkSheet = function(index) {


        $scope.WorkSheetJSAE.splice(index, 1);
...
// reviewer What' If
  ...
  $scope.showSelectedDataReviewer = function() {
    $scope.WhatReviewer = $scope.employeelist.filter(function(list) {
      return list.selected;
    });
  };

  $scope.removeItemReviewer = function(list) {
    var index = $scope.WhatReviewer.indexOf(list);
    if (index !== -1) {
      $scope.WhatReviewer.splice(index, 1);
    }
  };
...
//  Approver What' If
  ...
  $scope.showSelectedDataApprover = function() {
    $scope.WhatApprover = $scope.employeelist.filter(function(list) {
      return list.selected;
    });
  };

  $scope.removeItemApprover = function(list) {
    var index = $scope.WhatApprover.indexOf(list);
    if (index !== -1) {
      $scope.WhatApprover.splice(index, 1);
    }
  };
  ...
  $scope.followData = [
    {file:'HAZOP202300001',id:'00000001',},
    {file:'HAZOP202300002',id:'00000002',},
    {file:'HAZOP202300003',id:'00000001',},
    {file:'HAZOP202300004',id:'00000002',},
    {file:'HAZOP202300005',id:'00000003',},

  ];


  $scope.responder = [
    {id:'00000001',resname:'TOP XXX-Igor A',profile: 'assets/img/team/33.webp',},
    {id:'00000002',resname:'TOP XXX-Igor B',profile: 'assets/img/team/35.webp',},
    {id:'00000003',resname:'TOP XXX-Igor D',profile: 'assets/img/team/20.webp',},
  ...
  // รวมข้อมูล followData และ responder ด้วย id
  $scope.mergeData = function() {
    $scope.mergedData = $scope.followData.map(function(item) {
      var responderItem = $scope.responder.find(function(responder) {
        return responder.id === item.id;
      });

      return {
        file: item.file,
        id: item.id,
        resname: responderItem ? responderItem.resname : '',
        profile: responderItem ? responderItem.profile : ''
      };
    });
  };

  $scope.filterItems = function(id) {
    $scope.filteredItems = $scope.mergedData.filter(function(item) {
      return item.id === id;
    });

    // เมื่อกรองเสร็จสิ้น ให้ตรวจสอบข้อมูลที่เลือก
    var selectedItem = $scope.filteredItems[0];
    if (selectedItem) {
      $scope.selectedProfile = selectedItem.profile;
      $scope.selectedResname = selectedItem.resname;
    } else {
      $scope.selectedProfile = '';
      $scope.selectedResname = '';
    }
  };
  $scope.filterByFile = function(file) {
    var filteredItems = $scope.mergedData.filter(function(item) {
    ...
    // เรียกใช้งานฟังก์ชัน mergeData เพื่อรวมข้อมูลเมื่อโหลดหน้าเว็บ
    $scope.mergeData();


    $scope.showfollow = '2'; 

    $scope.ViewFollow = function ( a) {
    ...
    $scope.searchtext = function() {
      $scope.filteredData = $scope.followData.filter(function(item) {
        // ใช้เงื่อนไขการค้นหาด้วยฟังก์ชัน includes()
  ...
  //  $scope.actb = document.getElementById('FILE');
  //  $scope.filetest = null;
  ...
  $scope.embedPdf = function() {
    var options = {
      page: parseInt($scope.startPage)
    };
    PDFObject.embed($scope.pdfUrl, "#pdfViewer", options);
  };
  ...
  $scope.filterResults = function() {
    ...
    for (var i = 0; i < $scope.node_list.length; i++) {
      var result = $scope.node_list[i];
      if (result.deviations.toLowerCase().startsWith(searchText)) {
  ...
  $scope.selectResult = function(result,typef) {
    ...
    if(typef === 'projectname'){
      ...
      $scope.searchText = result.deviations +" "+ result.guide_word;
      $scope.filteredResults = [];
      $scope.showResults = false;
